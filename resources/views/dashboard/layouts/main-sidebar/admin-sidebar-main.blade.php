    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('dashboard.admin') }}">
                ...
                <span class="side-menu__label">{{trans('main-sidebar_trans.index')}}</a>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item"
                       href="{{ route('Add_GroupServices') }}">{{trans('main-sidebar_trans.group_services')}}</a></li>
                <li><a class="slide-item"
                ...
                <li><a class="slide-item"
                       href="{{ url('/' . $page='calendar') }}">{{trans('main-sidebar_trans.Ambulance_calls')}}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
